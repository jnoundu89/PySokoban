...
class SkinManager:
    ...
    def load_available_skins(self):
        ...
        skins_dir = os.path.join(os.path.dirname(__file__), 'assets')
    ...
    def _create_default_skin(self):
        ...
        """
        default_skin_dir = os.path.join(os.path.dirname(__file__), 'assets', 'default')
    ...
    def create_new_skin(self, skin_name):
        ...
        new_skin_dir = os.path.join(os.path.dirname(__file__), 'assets', skin_name)
